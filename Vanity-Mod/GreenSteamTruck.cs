namespace Eco.Mods.TechTree
{
    ...
    [Serialized]
    [Weight(25000)]  
    public class GreenSteamTruckItem : WorldObjectItem<GreenSteamTruckObject>
    {
        public override LocString DisplayName        { get { return Localizer.DoStr("Green Steam Truck"); } }
    ...
    public class GreenSteamTruckRecipe : Recipe
    {
    ...
    public partial class GreenSteamTruckObject : PhysicsWorldObject, IRepresentsItem
    {
        static GreenSteamTruckObject()
        {
            WorldObject.AddOccupancy<GreenSteamTruckObject>(new List<BlockOccupancy>(0));
        }

        public override LocString DisplayName { get { return Localizer.DoStr("Green Steam Truck"); } }
        public Type RepresentedItemType { get { return typeof(GreenSteamTruckItem); } }
