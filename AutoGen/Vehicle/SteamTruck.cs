namespace Eco.Mods.TechTree
{
    ...
    {
        public override LocString DisplayName        { get { return Localizer.DoStr("Red Steam Truck"); } }
        public override LocString DisplayDescription { get { return Localizer.DoStr("A red truck that runs on steam."); } }
    }
    ...
    public class SteamTruckRecipe : Recipe
    {
        public SteamTruckRecipe()
        {
            ...
            this.Initialize(Localizer.DoStr("Red Steam Truck"), typeof(SteamTruckRecipe));
